<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="School_FAlloc_Report.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.School_FAlloc_Report" %>
            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">University/College/School Fee Allocation Report</li>
                    </ol>
                </nav>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">University/College/School Fee Allocation Report</h5>
                        ...
                        <div class="table-responsive mb-1">
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Faci_Name" HeaderText="University/College/School" ItemStyle-VerticalAlign="Top" HtmlEncode="False" />
                                    <asp:BoundField DataField="Fee_Type" HeaderText="Fee" ItemStyle-VerticalAlign="Top" HtmlEncode="False" />
                                    <asp:BoundField DataField="Fee_Acc_No" HeaderText="Bank Account No." ItemStyle-VerticalAlign="Top" HtmlEncode="False" />
                                    <asp:BoundField DataField="" HeaderText="Currency" ItemStyle-VerticalAlign="Top" HtmlEncode="False" />
                                    <asp:BoundField DataField="FType_ID" HeaderText="Fee Code" ItemStyle-VerticalAlign="Top" HtmlEncode="False" />
                                    <asp:BoundField DataField="Submit_Date" HeaderText="Allocated Date" ItemStyle-VerticalAlign="Top" DataFormatString="{0:dd/M/yyyy}" />
                                    <asp:BoundField DataField="Faci_Reg_No" HeaderText="Region ID" ShowHeader="false">
