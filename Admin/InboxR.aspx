<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboxR.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.InboxR" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Inbox - University/College/School Registration List</h5>
