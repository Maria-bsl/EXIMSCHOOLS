<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditStu.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.AuditStu" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><label class="hd1 mb-0">Student Details</label></h5>
