<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stu_Det_Report.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.School_Det_Report" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvRegion" CssClass="red_new"
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvCountry" CssClass="red_new"
