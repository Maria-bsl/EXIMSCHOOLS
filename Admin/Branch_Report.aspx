            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">General Issued Invoices</li>
                    </ol>
                </nav>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">General Issued Invoices</h5>
                        ...
                        <div class="table-responsive mb-1">
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Issued Invoices" ItemStyle-Width="25%"
                                    ...
                                    <asp:TemplateField HeaderText="Invoiced Amount" ItemStyle-Width="25%"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
