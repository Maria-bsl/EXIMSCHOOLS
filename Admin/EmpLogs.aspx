<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpLogs.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.EmpLogs" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-85">
                                <label class="col-md-3 col-form-label pl-0">User </label>
                                <asp:DropDownList CssClass="Displaytext form-control" runat="server" ID="ddlUser"
                                    ...
                                    <asp:ListItem Value="school">University/College/School</asp:ListItem>
                                    <asp:ListItem Value="bank">Bank</asp:ListItem>
                                </asp:DropDownList>
                            </div>

                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-85">
                                <asp:Label Cssclass="col-md-3 col-form-label pl-0" runat="server" ID="lblSch"
                                    Visible="false">University/College/School</asp:Label>
                                <asp:DropDownList CssClass="Displaytext form-control" runat="server" ID="ddlSchool"
