...
CodeBehind="Fee_Bal_Report.aspx.cs" MasterPageFile="~/Head_Admin.Master"
Inherits="Schools.Admin.Fee_Bal_Report" %> <%@ MasterType
VirtualPath="~/Head_Admin.master" %>
  ...
  <script>
    $(document).ready(function () {
      ...
      if ($(gvDeptTable).length != 0) {
        var pageTotal = $("[id$=lblRATot]");
        var gvDeptFooter = $(pageTotal).parent().parent();
        ...
        if ($(gvDeptFooter).length != 0) {
          $(gvDeptTable).append(
            $("<tfoot/>").append($(this).find($(gvDeptFooter)))
          );
        }
        ...
        $(gvDeptTable).DataTable({
          ...
          footerCallback: function (row, data, start, end, display) {
            ...
            var value_feeAmountPageTotal =
              checkIsNaN(Intl.NumberFormat().format(feeAmountPageTotal)) ===
              true
                ? 0
                : Intl.NumberFormat().format(feeAmountPageTotal);

            // Update footer
            $(pageTotal).text(value_feeAmountPageTotal);
          },
        });
      }
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div
                class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120"
              >
                <label class="col-md-3 col-form-label pl-0">University/College/School</label>
                <asp:DropDownList
                  CssClass="col-md-9 form-control"
                  runat="server"
                  ID="ddlSchool"
                  AutoPostBack="true"
              ...
              >
                <asp:Label
                  Cssclass="col-md-3 col-form-label pl-0"
                  runat="server"
                  ID="lblDesig"
                  >Academic
                </asp:Label>
              ...
              >
                ...
                <asp:DropDownList
                  CssClass="col-md-9 form-control"
                  runat="server"
                  ID="ddlClass" AutoPostBack="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged"
                >
                </asp:DropDownList>
                <asp:RequiredFieldValidator
                  runat="server"
              ...
              >
                ...
                <asp:RequiredFieldValidator
                  ...
                  Display="Dynamic"
                  ErrorMessage="Please select Programme/Combination/Stream"
                ></asp:RequiredFieldValidator>
              </div>
              ...
              <div
                class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120"
              >
                <label class="col-md-3 col-form-label pl-0"
                  >Admission No.</label
                >
                <asp:TextBox
                  CssClass="col-md-9 form-control"
              ...
              <div class="form-group col-12 d-flex justify-content-end">
                <asp:Button
                  CssClass="btn btn-sm btn-biz_logic"
                  ID="btnSubmit"
                  runat="server"
                  Text="View Report"
                ...
                />
                <asp:Button
                  CssClass="btn btn-sm btn-biz_logic ml-1"
                  ID="btnPdf"
                  runat="server"
                  Text="Download PDF"
            ...
            <div class="table-responsive mb-1">
              <asp:GridView
                ID="gvDept"
                CssClass="table table-bordered mb-1 display"
                runat="server"
              ...
              >
                ...
                <Columns>
                  ...
                  <asp:BoundField
                    DataField="Section"
                    HeaderText="Programme/Combination/Stream"
                    ItemStyle-VerticalAlign="Top"
                    HtmlEncode="False"
                  />
                  <asp:BoundField
                    DataField="Student_Full_Name"
                    HeaderText="Student Name"
                    ItemStyle-VerticalAlign="Top"
                    HtmlEncode="False"
                  />
                  <asp:BoundField
                    DataField="Admission_No"
                    HeaderText="Admission No."
                    ItemStyle-VerticalAlign="Top"
                    HtmlEncode="False"
                  />
                  <asp:BoundField
                    DataField="Fee_Data_Sno"
            ...
            <div class="table-responsive mb-1">
              <asp:GridView
                ...
                ShowFooter="true"
                HeaderStyle-CssClass="HeaderDatagrid"
                OnRowDataBound="gvCopyRowDataBound"
                AllowPaging="false"
              >
                <RowStyle HorizontalAlign="Left" CssClass="FirstItemStyle" />
                <PagerStyle CssClass="gridViewPager" />
