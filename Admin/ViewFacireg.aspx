<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFacireg.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.ViewFacireg" %>
                            ...
                            <asp:gridview ID="Gridview1" runat="server" ShowFooter="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Account No">
                                        <ItemTemplate>
                                            <asp:TextBox CssClass="form-control" style="max-width: 275px;"
                                                ID="txtValidity" MaxLength="100" runat="server" Enabled="false"></asp:TextBox>
