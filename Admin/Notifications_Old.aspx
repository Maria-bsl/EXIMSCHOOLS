<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notifications_Old.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.Notifications_Old" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-7 row mx-0 format-190">
                                ...
                                <asp:ListItem class="asp-listItem col-form-label" Value="School/College Admins">School/College Admins </asp:ListItem>
