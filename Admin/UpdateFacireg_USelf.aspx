<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateFacireg_USelf.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.UpdateFacireg_USelf" %>
                            ...
                            <asp:gridview ID="Gridview1" runat="server" ShowFooter="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Account No">
                                        <ItemTemplate>
                                            <asp:TextBox CssClass="form-control" style="max-width: 275px;" ID="txtValidity" MaxLength="100"
                    ...
                    <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-145">
                        ...
                        <div class="form-group d-flex justify-content-end">
                            ...
                            <asp:Button CssClass="btn btn-sm btn-biz_logic ml-1" ID="btnReg" runat="server"
                                Text="Update" OnClientClick="return confirm('Are you sure you want to update?');"
