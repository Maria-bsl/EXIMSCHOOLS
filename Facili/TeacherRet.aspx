<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Faci.Master" AutoEventWireup="true" CodeBehind="TeacherRet.aspx.cs" Inherits="Schools.Facili.TeacherRet" %>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                        ...
                        <span class="red_new">*</span>
                        <asp:TextBox CssClass="col-md-9 form-control" ID="txtFirst" runat="server" 
                            MaxLength="100">
                        </asp:TextBox><br />
                    ...
                    <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                        ...
                        <asp:TextBox CssClass="col-md-9 form-control" ID="txtMiddle"  runat="server"
                            MaxLength="50">
                        </asp:TextBox>
                    </div>
                    <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                        ...
                        <span class="red_new">*</span>
                        <asp:TextBox CssClass="col-md-9 form-control" ID="txtLast" runat="server" 
                            MaxLength="100">
                        </asp:TextBox><br />
                    ...
                    <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                        ...
                        <span class="red_new">*</span>
                        <asp:TextBox CssClass="col-md-9 form-control" ID="txtEmail" runat="server" 
                            MaxLength="200">
                        </asp:TextBox><br />
                ...
                <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Programme/Combination/Stream">
                            <ItemTemplate>
                ...
                <div class="form-group d-flex justify-content-end">
                    ...
                    <asp:Button CssClass="btn btn-sm btn-biz_logic" ID="btnSubmit" runat="server" Text="Update" OnClientClick="return confirm('Are you sure you want to update?');"
                      CausesValidation="false"  OnClick="btnSubmit_Click" Visible="false" />
                    <asp:Button CssClass="btn btn-sm btn-biz_logic ml-1" ID="btnUpdate" runat="server" Text="Update" 
                         OnClientClick="return confirm('Are you sure you want to update?');"   OnClick="btnUpdate_Click"  />
                </div>
            </div>
        </div>
    </div>
