<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SectionRetInb.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.SectionRetInb" %>
            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Programme/Combination/Stream Return Inbox</li>
                    </ol>
                </nav>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Programme/Combination/Stream Return Inbox</h5>
