        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">View/Update University/College/School Info</li>
                </ol>
            </nav>
            <div class="card">
                <div class="card-body">

                    <h5 class="card-title">View/Update University/College/School Info</h4>

                        <div class="row">
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-160">
                                <label class="col-md-3 col-form-label pl-0">University/College/School Short Name<span
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-160">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvCPN" CssClass="red_new offset-md-3"
                                    ...
                                    ErrorMessage="Please enter University/College/School name">
                                </asp:RequiredFieldValidator>
                            </div>
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-160">
                                ...
                                <div class="col-md-9 px-0  input-group">
                                    ...
                                    <asp:TextBox CssClass="form-control" type="tel" runat="server"
