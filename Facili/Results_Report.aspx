<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Results_Report.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.Results_Report" %>
                    ...
                    <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Student_Full_Name" HeaderText="Student Name"
                                ItemStyle-VerticalAlign="Top" HtmlEncode="False" />
                            <asp:BoundField DataField="" HeaderText="Total Marks" ItemStyle-VerticalAlign="Top"
                                HtmlEncode="False" />
                            <asp:BoundField DataField="" HeaderText="Avg Grade" ItemStyle-VerticalAlign="Top"
                                HtmlEncode="False" />
                            <asp:BoundField DataField="" HeaderText="Result" ItemStyle-VerticalAlign="Top"
                                HtmlEncode="False" />
                        </Columns>
