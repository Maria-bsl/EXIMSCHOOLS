<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditStu.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.AuditStu" %>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 row mx-0">
                        ...
                        <div class="input-group col-md-9 px-0">
                            <asp:TextBox ID="txtTDate" CssClass="form-control Displaytext" runat="server">
                            </asp:TextBox>
                            <div class="input-group-append rounded-right">
                                <asp:ImageButton CssClass="input-group-text" runat="server" CausesValidation="false"
