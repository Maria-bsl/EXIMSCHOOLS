<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.Notifications" %>
                                            ...
                                            <div class="tab-pane fade show active py-2" id="nav-group" role="tabpanel"
                                                ...
                                                <div id="group_states" class="jumbotron mb-0 px-3 py-3">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control" for="super-admins">Teachers</label>
                                                    </div>
                                                    <div class="custom-control custom-checkbox">
