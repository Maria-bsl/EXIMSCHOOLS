<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditFeeUp.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.AuditFeeUp" %>
    ...
    <ContentTemplate>
        ...
        <nav aria-label="Page breadcrumb">
            <ol class="breadcrumb mb-1 bg-white py-1 border">
                ...
                <li class="breadcrumb-item">Fee data</li>
            </ol>
        </nav>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Fee data</h5>

                <div class="row">
                    <div class="form-group col-md-6 row mx-0 format-100">
