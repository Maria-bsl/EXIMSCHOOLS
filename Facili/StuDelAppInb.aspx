<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuDelAppInb.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.StuAppDelInb" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Students Deletion Approve Inbox</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Students Deletion Approve Inbox</h5>
                    ...
                    <div class="form-group d-flex justify-content-end">
                        <asp:Button CssClass="btn btn-sm btn-biz_logic" ID="btnSubmit" runat="server" Visible="false"
                            OnClientClick="return confirm('Are you sure you want to delete?');" Text="Delete All"
