<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attendance_Report.aspx.cs" MasterPageFile="~/Head_Teach.Master" Inherits="Schools.Teach.Attendance_Report" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"> <label class="hd1">Attendance Report</label></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 row mx-0">
                                <asp:Label Cssclass="col-md-3 col-form-label pl-0" runat="server" ID="Label4">From Date
                                    <span class="red_new">*</span>
                                </asp:Label>
                            ...
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Admission_No" HeaderText="Admission No"
                                        ItemStyle-VerticalAlign="Top" HtmlEncode="False" ItemStyle-Width="5%" />
                                    ...
                                    <asp:BoundField DataField="" HeaderText="Total Days" ItemStyle-VerticalAlign="Top"
                                        HtmlEncode="False" ItemStyle-Width="5%" />
