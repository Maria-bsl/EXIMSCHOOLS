<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeT_Report.aspx.cs" MasterPageFile="~/Head_Teach.Master" Inherits="Schools.Teach.TimeT_Report" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"> <label class="hd1">Timetable Report</label></h5>
                        <div class="row">
                            <div class="form-group col-sm-11 col-lg-6 row mx-0 format-130">
                                <asp:Label class="col-sm-4 col-md-3 col-form-label pl-0" runat="server" ID="Label1">
                                    Academic
                                    Year
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvAcad"
                                    CssClass="red_new offset-sm-4 offset-md-3" ControlToValidate="ddlAcademic"
                                    Display="Dynamic" ErrorMessage="Please select Year">
                                </asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-11 col-lg-6 row mx-0">
                                <asp:Label class="col-sm-4 col-md-3 col-form-label pl-0" runat="server" ID="Label2">
                                    Class
                                    <span class="red_new">*</span>
                                </asp:Label>
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvCname"
                                    CssClass="red_new offset-sm-4 offset-md-3" ControlToValidate="ddlClass"
                                    Display="Dynamic" ErrorMessage="Please select Class">
                                </asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-11 col-lg-6 row mx-0 format-130">
                                <asp:Label class="col-sm-4 col-md-3 col-form-label pl-0" runat="server" ID="Label3">
                                    Programme/Combination/Stream
                                    <span class="red_new">*</span>
                                </asp:Label>
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvSection"
                                    CssClass="red_new offset-sm-4 offset-md-3" ControlToValidate="ddlSection"
                                    Display="Dynamic" ErrorMessage="Please select Programme/Combination/Stream"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-11 col-lg-6 row mx-0">
                                <asp:Label class="col-sm-4 col-md-3 col-form-label pl-0" runat="server" ID="Label4">From
                                    Date
                                    <span class="red_new">*</span>
                                </asp:Label>
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvFDate" ControlToValidate="txtFDate"
                                    Display="Dynamic" CssClass="red_new offset-sm-4 offset-md-3"
                            ...
                            <div class="form-group col-sm-11 col-lg-6 row mx-0 format-130">
                                <asp:Label class="col-sm-4 col-md-3 col-form-label pl-0" runat="server" ID="Label5">To
                                    Date
                                    <span class="red_new">*</span>
                                </asp:Label>
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                                    ...
                                    CssClass="red_new offset-sm-4 offset-md-3" ErrorMessage="Please select to date">
                                </asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="cmpVal" ControlToCompare="txtFDate"
                                    ControlToValidate="txtTDate" Display="Dynamic"
                                    CssClass="red_new offset-sm-4 offset-md-3" Type="Date" Operator="GreaterThan"
