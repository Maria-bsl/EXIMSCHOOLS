<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Teach.Master" AutoEventWireup="true" CodeBehind="TimeTableApp.aspx.cs" Inherits="Schools.Teach.TimeTableApp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"><label class="hd1">TimeTable Approve</label></h5>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 row mx-0">
                    <asp:Label CssClass="col-md-3 col-form-label pl-0" runat="server" ID="Label2">Programme/Combination/Stream
                        <span class="red_new">*</span>
                    </asp:Label>
                    <asp:DropDownList CssClass="col-md-9 form-control" runat="server" Enabled="false" ID="ddlSection">
                    </asp:DropDownList>
            ...
            <div class="form-group col d-flex justify-content-end">
                <asp:Button CssClass="btn btn-sm btn-biz_logic" ID="btnSubmit" runat="server" OnClick="btnSubmit_Click"
                    OnClientClick="return confirm('Are you sure you want to approve');" Text="Approve" />
