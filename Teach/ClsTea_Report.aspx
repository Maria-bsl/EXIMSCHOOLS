<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClsTea_Report.aspx.cs" MasterPageFile="~/Head_Teach.Master" Inherits="Schools.Teach.ClsTea_Report" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><label class="hd1">Class vs Teachers Report</label></h5>
