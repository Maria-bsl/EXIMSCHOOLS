<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Results_M_Report.aspx.cs" MasterPageFile="~/Head_Teach.Master" Inherits="Schools.Teach.Results_M_Report" %>
            ...
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-10 col-md-8 col-lg-6 row mx-0">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvAcad" CssClass="red_new offset-md-4"
                                    ControlToValidate="ddlAcademic" Display="Dynamic" ErrorMessage="Please select Year">
                                </asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-10 col-md-8 col-lg-6 row mx-0">
                                <asp:Label CssClass="col-sm-4 col-form-label pl-0" runat="server" ID="Label2">Class
                                    <span class="red_new">*</span>
                                </asp:Label>
                                <asp:DropDownList CssClass="col-sm-8 form-control" runat="server" ID="ddlClass"
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ID="rfvCname" CssClass="red_new offset-md-4"
                                    ControlToValidate="ddlClass" Display="Dynamic" ErrorMessage="Please select Class">
                                </asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-10 col-md-8 col-lg-6 row mx-0">
                                <asp:Label CssClass="col-sm-4 col-form-label pl-0" runat="server" ID="Label3">Programme/Combination/Stream
                                    <span class="red_new">*</span>
                                </asp:Label>
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="rfvSection"
                                    CssClass="red_new offset-md-4" ControlToValidate="ddlSection" Display="Dynamic"
                                    ErrorMessage="Please select Programme/Combination/Stream"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-10 col-md-8 col-lg-6 row mx-0">
                                <asp:Label CssClass="col-sm-4 col-form-label pl-0" runat="server" ID="Label4">Exam
                                    <span class="red_new">*</span>
                                </asp:Label>
                                <asp:DropDownList CssClass="col-sm-8 form-control" runat="server" ID="ddlExam">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                                    CssClass="red_new offset-md-4" ControlToValidate="ddlExam" Display="Dynamic"
                                    ErrorMessage="Please select Exam"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-sm-10 col-md-8 col-lg-6 row mx-0">
                                <asp:Label CssClass="col-sm-4 col-form-label pl-0" runat="server" ID="Label5">Student
                                    Name
                                    <span class="red_new">*</span>
                                </asp:Label>
                                <asp:DropDownList CssClass="col-sm-8 form-control" runat="server" ID="ddlStu">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2"
                                    CssClass="red_new offset-md-4" ControlToValidate="ddlStu" Display="Dynamic"
                                    ErrorMessage="Please select student"></asp:RequiredFieldValidator>
                            </div>
                        </div>
