<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Teach.Master" AutoEventWireup="true" CodeBehind="AttndnceAppInb.aspx.cs" Inherits="Schools.Teach.AttndnceAppInb" %>
            ...
            <ContentTemplate>
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Attendance Approval Inbox</li>
                    </ol>
                </nav>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <asp:Label runat="server" ID="lblInbox" CssClass="hd1">Attendance Approval Inbox
                            </asp:Label>
                        </h5>
